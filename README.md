...
<div id="landing">
<nav class="lnav">
  <div class="logo" style="display:flex;flex-direction:column;align-items:center;gap:4px"><img src="https://files.manuscdn.com/user_upload_by_module/session_file/310519663187515352/TGtmyIpbwEAcIwlJ.png" style="height: 40px; width: auto; object-fit: contain;" alt="CAW Logo"><div class="logo-subtitle" style="font-size:9px;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:#000;line-height:1.2">TELECOM E ENERGIA</div></div>
...
<footer class="lfoot">
  <div class="logo" style="display:flex;flex-direction:column;align-items:center;gap:4px"><img src="https://files.manuscdn.com/user_upload_by_module/session_file/310519663187515352/TGtmyIpbwEAcIwlJ.png" style="height: 32px; width: auto; object-fit: contain;" alt="CAW Logo"><div class="logo-subtitle" style="font-size:8px;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:#000;line-height:1.2">TELECOM E ENERGIA</div></div>
...
<div class="modal">
  ...
  <div style="display:flex;align-items:center;gap:10px;margin-bottom:22px">
    <div class="logo" style="display:flex;flex-direction:column;align-items:center;gap:2px"><img src="https://files.manuscdn.com/user_upload_by_module/session_file/310519663187515352/TGtmyIpbwEAcIwlJ.png" style="height: 34px; width: auto; object-fit: contain;" alt="CAW Logo"><div class="logo-subtitle" style="font-size:7px;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:#000;line-height:1.2">TELECOM E ENERGIA</div></div>
...
<div class="shell">
  <aside class="sidebar" id="sidebar">
    <div class="sbh"><div class="logo" style="display:flex;flex-direction:column;align-items:center;gap:4px"><img src="https://files.manuscdn.com/user_upload_by_module/session_file/310519663187515352/TGtmyIpbwEAcIwlJ.png" style="height: 32px; width: auto; object-fit: contain;" alt="CAW Logo"><div class="logo-subtitle" style="font-size:8px;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:#000;line-height:1.2">TELECOM E ENERGIA</div></div></div>
...
function completeLesson(cid,mid,lid){
  ...
  courseViewer(); // Refresh to show next lesson or quiz
}
...
function ranking(){
  // Simple ranking based on completed courses
  const sorted = [...USERS]
...
function mDash(){
  const colabs = USERS.filter(u=>u.type==='colaborador');
  const gestores = USERS.filter(u=>u.type==='gestor');
...
// Init
window.onload = () => {
  // If user session persists, launchApp()
};
</script>
</body>
</html>
