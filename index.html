...
function certificate(){
  ...
  <div class="cert" id="certBlock">
    <div style="display:flex;align-items:center;justify-content:center;gap:10px;margin-bottom:5px"><img src="https://files.manuscdn.com/user_upload_by_module/session_file/310519663187515352/DIIBAXsmwNKjxaBJ.png" style="height:52px;width:auto;object-fit:contain;" alt="Telecom e Energia Logo"><div style="text-align:left"><div class="cert-co">TELECOM E ENERGIA</div><div class="cert-cos">Programa de Treinamento Técnico Interno</div></div>
    </div>
...
function viewUserCert(uid, cid){
  ...
  const certHtml=`
  <div class="cert" id="certBlock">
    <div style="display:flex;align-items:center;justify-content:center;gap:10px;margin-bottom:5px"><img src="https://files.manuscdn.com/user_upload_by_module/session_file/310519663187515352/DIIBAXsmwNKjxaBJ.png" style="height:44px;width:auto;object-fit:contain;" alt="Telecom e Energia Logo"><div style="text-align:left"><div class="cert-co">TELECOM E ENERGIA</div><div class="cert-cos">Programa de Treinamento Técnico Interno</div></div>
    </div>
    <div class="cert-h1" style="margin-top:5px;">Certificado de Conclusão</div>
    <div class="cert-h2">Este documento certifica que</div>
